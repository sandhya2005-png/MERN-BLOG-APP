  ...
  return (
    ...
    <form className='flex flex-col gap-4' onSubmit={handleSubmit}>
        ...
        <div className='flex gap-4 items-center justify-between border-4 border-teal-500 border-dotted p-3'>
            ...
            <Button type='button' className='px-2 py-1 text-sm font-medium bg-gradient-to-r from-purple-500 to-blue-500 text-white rounded-lg' size='sm' onClick={handleUploadImage} disabled={imageUploadProgress}>
                {imageUploadProgress ? (
        ...
        <Button type="submit" className='px-2 py-1 text-sm font-medium bg-gradient-to-r from-purple-500 to-blue-500 text-white rounded-lg'>
            Update post
        </Button>
